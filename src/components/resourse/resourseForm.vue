          ...
          <el-col :sm="{span:20,offset:2}" :xs="23">
            <el-form label-width="120px" :model="model" ref="form" :rules="rules" :class="viewshow? 'lookForm':''">
              ...
              <el-form-item label="图片:" prop="purl">
                <span v-show="viewshow">{{model.purl.substring(model.purl.lastIndexOf('/')+1)}}</span>
                <el-upload
                  class="upload-demo"
                  v-show="!viewshow"
                  ref="upload"
                  ...
                  <span>{{model.purl.substring(model.purl.lastIndexOf('/')+1)}}</span>
                </el-upload>
              </el-form-item>
              <el-form-item label="点击次数:" prop="clicknum" class="inlineBlock">
                <span v-show="viewshow">{{model.clicknum}}</span>
                <el-input v-show="!viewshow" style="width:100%" v-model="model.clicknum"></el-input>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>

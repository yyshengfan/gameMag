    ...
    <el-card class="box-card changeMar MyContainerCon">
      ...
      <div style="margin-top: 2rem">
        <div class="searchtable">
          ...
          <div>
            <el-date-picker type="date" v-model="filters.etime" format="yyyy-MM-dd"
                            value-format="yyyy-MM-dd 23:59:59" style="width: 100%" placeholder="结束时间">
            </el-date-picker>
          </div>
          <div>
          ...
          <el-button type="primary" style="height: 38px;" v-loading="exportLoading" icon="el-icon-news" @click="excel()"
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button
                  ...
                  size="mini" icon="fa fa-download" type="primary" class="status"

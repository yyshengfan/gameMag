...
<template>
  <div>
    <div class="contentTitleModel">
      ...
      <span class="first"> 渠道下线</span>
    </div>
    <div style="margin:10px 0 "></div>
    <div v-loading="loading">
      <el-row :gutter="10">
        <el-form v-loading="loading" :model="model" :rules="rules" ref="form"  label-width="120px" >
          ...
          <el-form-item label="备注说明" prop="remark1">
...
<script>
  ...
  var model = function(){
    return {
      channel_id:'',offstatus:'0',off_time:'',remark1:''
    }
  }
  form.props= ['dialogOffLine','channelId']
  form.data=function () {
    return {
      loading: false,
      model:model(),
      rules:{
        ...
        remark1:[{ required: true, message: '请输入备注', trigger: 'blur' },
  ...
  form.methods.saveIt=function () {
    ...
    if(this.model.offstatus=='0'){
      ...
      params={channel_id:this.channelId,off_time:this.model.off_time,remark1:this.model.remark1}
    }
